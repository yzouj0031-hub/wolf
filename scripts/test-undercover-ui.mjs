...
expect(!js.includes('if (!seat || this._running) return'), '对局运行中仍然禁止打开玩家/API配置');
expect(js.includes('uc-seat-config') && css.includes('.uc-seat-config'), '席位中没有可见的玩家/API设置入口');
expect(css.includes('body.uc-configuring #pcpop{z-index:1200'), '玩家/API配置层会被卧底全屏界面遮挡');
expect(css.includes('#pc-test-api'), '界面内未突出显示API测试入口');
