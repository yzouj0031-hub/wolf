...
for (const feature of ['personal_ai','hosted_ai','last_seen_at','postgres_changes','sessionStorage','room_code','online_room_ai_seats','online_update_provider','online_configure_ai_fill','host_fill','balanced']) has(client,feature,`client feature ${feature}`);
