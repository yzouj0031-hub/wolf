(function () {
  ...
  const EXACT = {
    ...
    '赛后互动':'Post-game interaction','游戏结束，上帝视角——身份全公开，什么都能说':'Game over · omniscient view · all roles revealed','开启终局盲复盘':'Enable blind final review','对局回放':'Match replay','只读录像 · 按真实事件顺序播放，不调用 AI，也不会改变对局':'Read-only replay · chronological events · no AI calls or game changes','自动播放':'Auto play','显示本段全部':'Show all','本阶段暂无可显示事件':'No visible events in this phase',
